...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='evento',
            name='archivo',
            field=models.FileField(blank=True, null=True, upload_to='eventos/2022/7/7/'),
        ),
        migrations.AlterField(
            model_name='oficio',
            name='archivo',
        ...
        migrations.AlterField(
            ...
            field=models.DateField(blank=True, default=datetime.datetime(2022, 7, 10, 18, 47, 18, 147887), null=True),
        ),
        migrations.AlterField(
            model_name='oficio',
            name='modi_el',
        ...
        migrations.AlterField(
            ...
            name='archivo',
            field=models.FileField(blank=True, null=True, upload_to='oficios_respuestas/2022/7/7/', validators=[siad.functions.validate_file_extension, siad.functions.file_size]),
        ),

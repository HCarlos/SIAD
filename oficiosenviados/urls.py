...
from oficiosenviados.views import OficioEnviados_list, OficioEnviado_new, OficioEnviados_edit, OficioEnviados_remove, \
    OficioEnviado_respuestas_list, oficioenviado_respuesta_new, \
    oficioenviado_respuesta_edit, oficioenviado_respuesta_remove, OficiosEnviados_search_data_list
...
urlpatterns = [
    ...
    path('oficiosenviados_search_data_list', OficiosEnviados_search_data_list, name='oficiosenviados_search_data_list'),

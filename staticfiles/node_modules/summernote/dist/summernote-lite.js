  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function initialize() {
      ...
      this.$dialog = this.ui.dialog({
        ...
        footer: body,
        callback: function callback($node) {
          $node.find('.modals-body,.note-modals-body').css({
            'max-height': 300,
            'overflow': 'scroll'
          });
        }
...
var ModalUI_ModalUI = /*#__PURE__*/function () {
  ...
  /*, options */
    ...
    this.$modal = $node;
    this.$backdrop = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div class="note-modals-backdrop"/>');
  }
  ...
  ModalUI_createClass(ModalUI, [{
    ...
    value: function show() {
      ...
      this.$modal.trigger('note.modals.show');
    ...
    value: function hide() {
      ...
      this.$backdrop.hide();
      this.$modal.trigger('note.modals.hide');
...
var dialog = renderer["a" /* default */].create('<div class="note-modals" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  if (options.fade) {
    $node.addClass('fade');
  }
  ...
  $node.html(['<div class="note-modals-content">', options.title ? '<div class="note-modals-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modals-title">' + options.title + '</h4></div>' : '', '<div class="note-modals-body">' + options.body + '</div>', options.footer ? '<div class="note-modals-footer">' + options.footer + '</div>' : '', '</div>'].join(''));
...
var ui = function ui(editorOptions) {
  return {
    ...
    onDialogShown: function onDialogShown($dialog, handler) {
      $dialog.one('note.modals.show', handler);
    },
    onDialogHidden: function onDialogHidden($dialog, handler) {
      $dialog.one('note.modals.hide', handler);
    },
    ...
    getDialogBody: function getDialogBody($dialog) {
      return $dialog.find('.note-modals-body');
    },

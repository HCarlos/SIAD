...
(function (global, factory) {
		...
		guiStyles: {
			...
			bootstrap: {
				...
				dialog: {
					...
					window: "modals ui-jqgrid-bootstrap",
					document: "modals-dialog",
					subdocument: "modals-content",
					body: "modals-body",
	...
	*/
	...
	$.extend(jgrid, {
		...
		// The modul can support multiple modals dialods. It hold the information about evety active modules in internal array of "hashes".
		// The modals dialogs as hidden typically. Before the dialog will be visible onShow callback (showModal) will be called.
		//
		// Every eleement contains "hash object" which have 4 properties:
		//  w: (jQuery object) The modals element, represent the outer div of the modals dialog
		//  o: (jQuery object) The overlay element. It will be assigned on the first opening of the modals
		//  c: (object) The modals's options object. The options used durin creating the modals.
		//          One can use global $.jgrid.jqModal or gris specifif p.jqModal to specify defaults of the options.
		//  t: (DOM object) The triggering element.
		//  s: numeric part of "id" used for modals dialog. The modals dialog have class "jqmID" + s.
		//  a: Boolean. It's false initially. It will be set to true during opening and will set to false on closing.
		showModal: function (h) {
			//  w: (jQuery object) The modals element
			h.w.show();
		},
		closeModal: function (h) {
			//  w: (jQuery object) The modals element
			//  o: (jQuery object) The overlay element
			//  c: (object) The modals's options object
		...
		createModal: function (aIDs, content, o, insertSelector, posSelector, appendsel, css) {
			...
			p != null ? p.jqModal || {} : {},
			o);
			// create main window "div.ui-jqdialog", which will contains other components of the modals window:
			...
			// modals dialog OUT OF visible part of/ the window if <body dir="rtl">.
	...
	var jqmHashLength = 0,
		...
		keyOrMouseEventHandler = function (e) {
			...
			if (e.type !== "mousedown" && isEventInsideOfModal()) {
				// allows keyboard events inside of the modals
				return true;
			}
	...
	$.jqm = {
		...
		open: function (s, trigger) {
			...
			if ($(h.w[0].ownerDocument).data("ui-dialog-overlays")) {
				h.w.addClass("ui-dialog"); // hack to allow input inside of jQuery UI modals
			}
			if (options.modal) {
				if (!createdModals[0]) {
					setTimeout(function () {
